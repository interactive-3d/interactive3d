...
class BaseSystem(pl.LightningModule, Updateable, SaverMixin):
    ...
    class Config:
        ...
        edit_loss: dict = field(default_factory=dict)
...
class BaseLift3DSystem(BaseSystem):
    ...
    class Config(BaseSystem.Config):
        ...
        # init
        init: bool = False
        init_type: str = "shap-e"
        eval_white_bg: bool = False

        # edit guidance
        edit_guidance_type: str = ""
        edit_guidance: dict = field(default_factory=dict)
