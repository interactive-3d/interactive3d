...
class Zero123UnifiedGuidance(BaseModule):
    ...
    class Config(BaseModule.Config):
        ...
        pretrained_model_name_or_path: str = "bennyguo/zero123-diffusers" # /cpfs01/shared/Gveval3/gongkaixiong/dlh/zero123_weights/zero123
    ...
    def configure(self) -> None:
        ...
        pipe_kwargs = {
            ...
            "local_files_only=True": True # NOTE
        }
        print("====name===", self.cfg.pretrained_model_name_or_path)
