...
@threestudio.register("pixart-guidance")
class PixartGuidance(BaseObject):
    @dataclass
    class Config(BaseObject.Config):
        ...
        guidance_scale: float = 20.0 # 100.0
        grad_clip: Optional[
            Any
    ...
    def configure(self) -> None:
        ...
        threestudio.info(f"Loaded Pixart-alpha!")
    ...
    def forward_transformer(
        ...
        encoder_attention_mask: Float[Tensor, "..."],
        ...
        return self.transformer(
            ...
            encoder_attention_mask=encoder_attention_mask.to(self.weights_dtype),
    ...
    def compute_grad_sds(
        ...
        if prompt_utils.use_perp_neg:
            ...
            text_embeddings, prompt_attention_mask = prompt_utils.get_text_embeddings(
                elevation, azimuth, camera_distances, self.cfg.view_dependent_prompting
            )
            ...
            with torch.no_grad():
                ...
                noise_pred = self.forward_transformer(
                    ...
                    torch.cat([t] * 2),
                    encoder_hidden_states=text_embeddings,
                    # encoder_hidden_states=text_embeddings_debug,
        ...
        #     save_imgs = torch.cat([latents, latents_noisy, pred_x0], dim=0)
        #     save_imgs = (save_imgs + 1)/2.
        #     save_imgs = save_imgs[:, :3]
        #     save_image(save_imgs, 'debug_data/pix.png', nrow=4)
        #     with torch.no_grad():
        #         image = self.vae.decode(pred_x0 / self.vae.config.scaling_factor, return_dict=False)[0]
        #         org_image = self.vae.decode(latents / self.vae.config.scaling_factor, return_dict=False)[0]
        #     image = torch.cat([org_image, image])
        #     image = (image + 1.)/2.
        #     save_image(image, 'debug_data/pix2.png', nrow=4)
        ...
        **kwargs,
        ...
        if rgb_as_latents:
            ...
            rgb_BCHW_512 = F.interpolate(
                ...
                rgb_BCHW, (res, res), mode="bilinear", align_corners=False
            )
