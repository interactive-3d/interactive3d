    ...
    def forward(
        ...
        **kwargs,
        ...
        if ambient_ratio is not None:
            ...
            if force_diffuse_light_color is not None:
                diffuse_light_color = force_diffuse_light_color
        ...
        self.cur_diffuse_light_color = diffuse_light_color
        ...
        #
        if force_shading is not None:
            shading = force_shading

        # record current shading
        self.cur_shading = shading
